...
- There's a ton of helpful third party libraries available (like RxSwift) in the market right now. However, in my opinion, using first party libraries are more than enough to complete this task.
